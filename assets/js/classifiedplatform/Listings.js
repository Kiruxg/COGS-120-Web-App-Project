...
addPriceIcon = index =>{
    if (this.state.filteredData[index] !== undefined){
     ...
     if (match.params.category === 'Resources' ||
         match.params.category === 'Events' || match.params.listings === 'Roommates') {
         return ''
     } else if(match.params.category === 'Sale' ||
         (match.params.category === 'Housing' && this.state.filteredData[index].listing !== 'Roommates') ) {
         return '$'
     }
     }
}
                ...
                <section className='listloop' key={i}>
                    ...
                    <div className='item' onClick={() => <Item globalState={this.state} item={item}/> }>
                            <div className='image' style= 
                                ...
                                <p className='price'>{this.addPriceIcon(i)}{item.price}</p>
                 ...
                 } else if (match.params.category === item.category &&
                            match.params.listings === undefined
                           ){
                      const newTo = {
...
submitForm = () => {
    ...
    var newData = this.state.postArray.filter((item, i) => {
                    return parseInt(item.price) >= (this.state.min_price? this.state.min_price: 0 ) &&
                    parseInt(item.price) <= (this.state.max_price ? this.state.max_price : Number.MAX_SAFE_INTEGER)  
            ...
            <div className='container'>
                ...
                <section className='list-view'>
                    ...
                    <label>Price</label>
                        ...
                        <div className='reset-btn' onClick={this.resetData.bind(this)}>Reset</div>
                    </div>
                    </div>
